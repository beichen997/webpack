...
styleLoader.pitch = function (remainingRequest) {
  /* 1.直接使用style-loader,只能处理样式，不能处理央视中引入的其他资源
     use:[".loader/demo/style-loader1.js"]
     2.借助css-loader解决样式中引入其他资源的问题
     use:[".loader/demo/style-loader1.js",'css-loader']
     问题是css-loader暴漏了一段js代码，style-loader需要执行js代码，得到返返回值，再动态创建style标签，插入到页面上
     不好操作
     3.style-loader中使用pitch loader方法
  /*
  remainingRequest剩下还需要执行的loader
